...
*Booth Categories* allow users to define custom booth categories. These categories can be used to
assign different price tiers and :doc:`sponsors <event_sponsors>` for multiple booths at once.
